...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_label_set_text(ui->screen_menu_1_label_1, "item");
    lv_obj_set_size(ui->screen_menu_1_label_1, LV_PCT(100), LV_SIZE_CONTENT);
    lv_obj_set_scrollbar_mode(ui->screen_menu_1_subpage_1, LV_SCROLLBAR_MODE_OFF);
    ...
    lv_label_set_text(ui->screen_menu_1_label_2, "item");
    lv_obj_set_size(ui->screen_menu_1_label_2, LV_PCT(100), LV_SIZE_CONTENT);
    lv_obj_set_scrollbar_mode(ui->screen_menu_1_subpage_2, LV_SCROLLBAR_MODE_OFF);
    ...
    lv_label_set_text(ui->screen_menu_1_label_3, "item");
    lv_obj_set_size(ui->screen_menu_1_label_3, LV_PCT(100), LV_SIZE_CONTENT);
    lv_obj_set_scrollbar_mode(ui->screen_menu_1_subpage_3, LV_SCROLLBAR_MODE_OFF);
    ...
    lv_obj_set_pos(ui->screen_menu_1, 2, 5);
    lv_obj_set_size(ui->screen_menu_1, 473, 312);
    ...
    ui->screen_datetext_1 = lv_label_create(ui->screen_menu_1_subpage_1);
    ...
    lv_obj_set_pos(ui->screen_datetext_1, 114, 109);
    ...
    ui->screen_digital_clock_1 = lv_dclock_create(ui->screen_menu_1_subpage_1, "11:25:50");
    ...
    lv_obj_set_pos(ui->screen_digital_clock_1, 96, 168);
