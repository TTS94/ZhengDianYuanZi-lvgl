...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->screen_menu_1, -1, -1);
    lv_obj_set_size(ui->screen_menu_1, 320, 241);
    ...
    lv_label_set_text(ui->screen_menu_1_label_1, "Display");
    ...
    lv_label_set_text(ui->screen_menu_1_label_2, "ADD");
    ...
    lv_label_set_text(ui->screen_menu_1_label_3, "LED");
    ...
    lv_obj_set_size(ui->screen_cont_1, 214, 221);
    ...
    lv_obj_set_pos(ui->screen_digital_clock_1, 40, 95);
    ...
    lv_obj_set_pos(ui->screen_datetext_1, 38, 31);
    lv_obj_set_size(ui->screen_datetext_1, 130, 36);
    lv_label_set_text(ui->screen_datetext_1, "2025/12/01");
    ...
    ui->screen_btn_1 = lv_button_create(ui->screen_menu_1_subpage_2_cont);
    lv_obj_set_pos(ui->screen_btn_1, 48, 169);
    ...
    ui->screen_bar_1 = lv_bar_create(ui->screen_menu_1_subpage_2_cont);
    lv_obj_set_pos(ui->screen_bar_1, 12, 131);
    lv_obj_set_size(ui->screen_bar_1, 198, 24);
    lv_obj_set_style_anim_duration(ui->screen_bar_1, 1000, 0);
    lv_bar_set_mode(ui->screen_bar_1, LV_BAR_MODE_NORMAL);
    lv_bar_set_range(ui->screen_bar_1, 3, 100);
    lv_bar_set_value(ui->screen_bar_1, 3, LV_ANIM_OFF);
    ...
    ui->screen_ta_1 = lv_textarea_create(ui->screen_menu_1_subpage_2_cont);
    lv_obj_set_pos(ui->screen_ta_1, 51, 88);
    lv_obj_set_size(ui->screen_ta_1, 128, 30);
    lv_textarea_set_text(ui->screen_ta_1, "0");
    ...
    lv_textarea_set_max_length(ui->screen_ta_1, 8);
#if LV_USE_KEYBOARD
    ...
    ui->screen_label_1 = lv_label_create(ui->screen_menu_1_subpage_2_cont);
    lv_obj_set_pos(ui->screen_label_1, 77, 14);
    lv_obj_set_size(ui->screen_label_1, 63, 19);
    lv_label_set_text(ui->screen_label_1, "Score");
    ...
    lv_obj_set_pos(ui->screen_led_1, 80, 49);
    ...
    ui->screen_arc_1 = lv_arc_create(ui->screen_menu_1_subpage_3_cont);
    lv_obj_set_pos(ui->screen_arc_1, 38, 132);
    lv_obj_set_size(ui->screen_arc_1, 125, 99);
