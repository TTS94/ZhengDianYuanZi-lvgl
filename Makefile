##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [3.17.1] date: [Thu Dec 18 09:16:15 CST 2025] 
##########################################################################################################################
...
# target
######################################
MCU_PYOCD = stm32f103ze
TARGET = ZhengDianYuanZi
...
install: all
	pyocd flash -f 24m --erase sector --target $(MCU_PYOCD) $(BUILD_DIR)/$(TARGET).hex
